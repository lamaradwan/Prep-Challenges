...
const getInfo = (arr) => {
  ...
  let studentsName = [];
  // write your code here
  for(let cName of Object.values(arr)){
      coursesName.push(cName.course);
  }
  for(let stuNames of Object.values(arr)){
      for(let s=0; s<stuNames.Students.length; s++){
          studentsName.push(stuNames.Students[s])
      }
  }
