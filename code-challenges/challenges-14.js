...
const LastWord_2 = (str) => {
    ...
    return newText.slice(newText.length-1).toString()
}
// -------------------------------------------------------------------------------------------------------
...
const replaceWords = (str) => {
    // write your code here
    let newInput = str.split(' ')
    let indexI = newInput.indexOf('I')
    let indexAm = newInput.indexOf('am')
    let indexWas = newInput.indexOf('was')
    if(indexI != -1){
    newInput.splice(indexI,1,'We')
    }
    if(indexAm != -1){
    newInput.splice(indexAm,1,'are')
    }
    if(indexWas != -1){
    newInput.splice(indexWas,1,'were')
    }
